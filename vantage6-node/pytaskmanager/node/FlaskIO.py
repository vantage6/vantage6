...
class ClientBaseProtocol(object):
    ...
    def authenticate(self, credentials: dict):
        ...
        # authenticate
        url = self.generate_path_to("token")
...
class ClientContainerProtocol(ClientBaseProtocol):
    ...
    def authenticate(self, api_key: str):
        ...
        """
        super(ClientContainerProtocol, self).authenticate({"api_key": api_key})
...
class ClientNodeProtocol(ClientBaseProtocol):
    ...
    def authenticate(self, api_key: str):
        ...
        super(ClientNodeProtocol, self).authenticate({"api_key": api_key})
