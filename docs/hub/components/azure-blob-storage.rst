...
See :ref:`hq-configure` for more details on the configuration,
and :ref:`blob-storage` for more information. Note that you need to create an Azure
Blob Storage service from Azure - this cannot be done from vantage6.