...
import { ResetTokenForm } from 'src/app/models/forms/login-form.model';
...
export class MfaRecoverComponent {
  ...
  async onSubmit(): Promise<void> {
    ...
    const success = await this.authService.MFARecover(this.recoverForm.value as ResetTokenForm);
    if (success) {
